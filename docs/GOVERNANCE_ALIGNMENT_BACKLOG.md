...
`author="HireLens"` on both documents (was lines 218/409); both footers now read
`"Generated by HireLens  •  Confidential"` (was 359/563, since shifted by an
...
or any other vendor string; `author=HireLens`; footer present on both; the
