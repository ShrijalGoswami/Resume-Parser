...
| Retry-After honored over backoff (waited ~retry_after, not base) | ✅ PASS | elapsed=0.063s, calls=2 |
| Recovers after transient failures (success on 3rd attempt) | ✅ PASS | calls=3 |
| Total added latency bounded by the delay cap | ✅ PASS | elapsed=0.125s (cap=100ms × 2 waits) |
