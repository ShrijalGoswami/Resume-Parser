...
export const metadata: Metadata = {
  title: { default: 'Sign in', template: '%s · Hirevo' },
  /**
   ...
   * nothing about Hirevo and, when it outranks the page that would have, it
   ...
   */
  description:
    'Sign in to Hirevo, or create an account. Every new organization starts on the free plan.',
