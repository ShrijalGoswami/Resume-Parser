...
/**
 * Customers interact with HireLens, not the LLM vendor underneath it.
 *
...
const REQUIRED_ATTRIBUTION = /HireLens/
...
describe('exported interview pack attribution', () => {
  ...
  it('carries the neutral HireLens attribution', () => {
  ...
  it('the guard bites on the exact string GAB-D1 removed', () => {
    ...
    expect('Generated by HireLens • Powered by Groq LLM • Confidential').toMatch(VENDOR)
    expect('Generated by HireLens • Confidential').not.toMatch(VENDOR)
  })
})
